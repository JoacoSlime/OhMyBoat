...

{
    ...
    if (context.Usuarios.IsNullOrEmpty())
    {
        ...
        context.Clientes.Add(new OhMyBoat.UI.Shared.Entidades.Cliente() { Email = "pepoelpeposo@yahoo.com", Nombre="pepo Ramallo", Password = "0eb6f152d72087e15b6d61aa17ddafdce855f96330d56f004f129e4504d60c5d", Rol = OhMyBoat.UI.Shared.Entidades.Roles.cliente });// contra Agua1234.
        context.SaveChanges();
    }
